...
k_celeb_face1000_test_result_url = "ftp://mldisk.sogang.ac.kr/data/vtt/result/kr_celeb_crop_face_1000_test_result.zip"
...
check_and_downlaod(k_celeb_face1000_test_result_url, 'kr_celeb_crop_face_1000_test.zip', unzip=True)
print 'Done.'